...
module.exports.run = (client, message, args) => {
    ...
    if (!message.member.roles.find("Sunucu Yetkili")) {
        return message.channel.send(' **Bu Komutu Kullanmak için** \*`Sunucu Yetkili\` **Rolüne Sahip Olman Lazım** ')
...
exports.help = {
    name: 'seslisustur',
    description: 'Sesli de mute atarsınız.',
    usage: "seslisustur"
};
